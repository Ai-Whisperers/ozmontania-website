...
export default function ObraDetailPage() {
  ...
  const messagingUrl = getMessagingUrl(waMessage)
            ...
            <Reveal variant="right" delay={150}>
              <div className="px-4 sm:px-0">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  {obra.has_print && (
                    <a href={messagingUrl} target="_blank" rel="noopener noreferrer" className="btn-primary text-sm sm:text-base justify-center">
